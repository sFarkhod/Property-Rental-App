"""
Django settings for propertyRentalBackend project.
...
SECRET_KEY = 'django-insecure-t@hwp2z0%b_t^azun+9knxmf@piyjfes0%0!-@&m8*%-%d6dsu'
...
WSGI_APPLICATION = 'propertyRentalBackend.wsgi.application'
